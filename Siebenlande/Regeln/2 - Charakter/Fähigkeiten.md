...
Beispiele:
- Auf schwerem Gelände nicht ausrutschen
- Einen Enterhaken auf ein Dach werfen
- Beim Sprung von einem Dach abrollen
### Heimlichkeit
...
### Instrumente
**Instrumente** umschreibt die Fähigkeit, mit verschiedenen Sorten von Instrumenten umzugehen. Diese spalten sich in vier Kategorien auf, die jeweils ihre eigene Fähigkeit darstellen:
- **Blasinstrumente**,
- **Saiteninstrumente**,
...
## 4. Konstitution
### Widerstand
**Widerstand** gibt [[Resistenz|Schmerzresistenz]] im Kampf und außerhalb. Widerstand gilt als Bonus bei der natürlichen Wundheilung von [[Ausdauer#Verletzungen|Verletzungen]].

## 5. Wahrnehmung
*__Lippenlesen__ ist jetzt ein Talent.*
### Einschätzen
**Einschätzen** hilft dabei, unbekannte Gefahren zu erkennen. Lässt sich das Gegenüber in einer Lüge ertappen? Verbirgt sich in diesem Raum ein Risiko? Wird dir Brücke unter mir zusammenbrechen? Ist das hier ein Hinterhalt?
> *Ist hier etwas im Gange?*
### Spurensuche
**Spurensuche** kann dem Charakter dabei helfen, die Fährte eines Verfolgten aufzunehmen, Indizien an einem Tatort zu sammeln, versteckte Mechanismen aufzuspüren, usw.
...
### Entschlüsseln
**Entschlüsseln** ermöglicht es, die Bedeutung alter Runen zu ergründen, Chiffren zu entschlüsseln, Geheimbotschaften in anderweitig unauffälligen Texten zu entdecken, Objekte als magische Artefakte zu enttarnen, usw.
...
### Nachforschen
**Nachforschen** erlaubt es, wichtige Informationen von unwichtigen zu trennen, staubige Folianten nach Hinweisen zu durchsuchen, die Mechanik magischer Artefakte zu erproben, und im passenden Moment die richtigen Fragen zu stellen.
...
*Siehe [[Ausdauer#Verletzungen|Verletzungen]]*
### Überlebenskunst
**Überlebenskunst** stellt die nötige Erfahrung dar, um sich in freier Natur zurechtzufinden, dem eigenen Abendessen eine Falle zustellen, keine giftigen Pflanzen zu vertilgen, das Nachtlager vor unerwünschten Blicken zu verbergen, etc.
### Wissen
**Wissen** beschreibt die allgemeinen Kenntnisse eines Charakters in verschiedenen Themengebieten, jedes davon stellt eine eigene Kategorie dar. Diese sind:
- **Adel**,
- **Geografie**,
- **Geschichte**,
- **Gebräuche**,
...
### Auftreten
**Auftreten** beschreibt eine Vielzahl von künstlerischen Fähigkeiten, die für jeden guten Darsteller nötig sind. Diese sind:
- **Gesang**,
- **Rhetorik**,
- **Schauspiel**, und
- **Tanzen**.
...
## Handwerk
Handwerk ordnet sich in ein Attribut entsprechend der Tätigkeit ein.
